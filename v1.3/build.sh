...
echo "Building private DNA v1.3 (bug fix: get_user_profile update chain)..."
...
cp workdir/flowsta_private_v1_3.dna workdir/dnas/
...
echo ""
echo "✅ Build complete (v1.3)!"
echo "DNA bundle: workdir/flowsta_private_v1_3.dna"
echo "hApp bundle: workdir/flowsta_private_v1_3_happ.happ"
echo ""
echo "File sizes:"
