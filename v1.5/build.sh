...
echo "Building private DNA v1.5 (bug fix: recursive update chain following)..."
...
cp workdir/flowsta_private_v1_5.dna workdir/dnas/
...
echo ""
echo "✅ Build complete (v1.5)!"
echo "DNA bundle: workdir/flowsta_private_v1_5.dna"
echo "hApp bundle: workdir/flowsta_private_v1_5_happ.happ"
echo ""
echo "File sizes:"
