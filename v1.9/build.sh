...
echo "Building private DNA v1.9 (Zero-knowledge analytics: analytics_ids stored in Holochain)..."
...
cp workdir/flowsta_private_v1_9.dna workdir/dnas/
...
echo ""
echo "✅ Build complete (v1.9)!"
echo "DNA bundle: workdir/flowsta_private_v1_9.dna"
echo "hApp bundle: workdir/flowsta_private_v1_9_happ.happ"
echo ""
echo "File sizes:"
