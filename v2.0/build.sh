...
echo "Building private DNA v2.0..."
...
cp workdir/flowsta_private_v2_0.dna workdir/dnas/
...
echo ""
echo "✅ Build complete (v2.0)!"
echo "DNA bundle: workdir/flowsta_private_v2_0.dna"
echo "hApp bundle: workdir/flowsta_private_v2_0_happ.happ"
echo ""
echo "File sizes:"
