...
echo "Building private DNA v1.2..."
...
cp workdir/flowsta_private_v1_2.dna workdir/dnas/
...
echo ""
echo "✅ Build complete (v1.2)!"
echo "DNA bundle: workdir/flowsta_private_v1_2.dna"
echo "hApp bundle: workdir/flowsta_private_v1_2_happ.happ"
echo ""
echo "File sizes:"
