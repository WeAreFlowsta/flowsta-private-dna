...
echo "Building private DNA v1.4 (bug fix: get_recovery_phrase update chain)..."
...
cp workdir/flowsta_private_v1_4.dna workdir/dnas/
...
echo "DNA bundle: workdir/flowsta_private_v1_4.dna"
echo "hApp bundle: workdir/flowsta_private_v1_4_happ.happ"
echo ""
echo "File sizes:"
