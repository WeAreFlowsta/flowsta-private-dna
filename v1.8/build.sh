...
echo "Building private DNA v1.8 (Holochain 0.6 upgrade: HDK 0.6.0, delete_link fix)..."
...
cp workdir/flowsta_private_v1_8.dna workdir/dnas/
...
echo "DNA bundle: workdir/flowsta_private_v1_8.dna"
echo "hApp bundle: workdir/flowsta_private_v1_8_happ.happ"
echo ""
echo "File sizes:"
