...
cp workdir/flowsta_private.dna workdir/dnas/
...
echo ""
echo "✅ Build complete!"
echo "DNA bundle: workdir/flowsta_private.dna"
echo "hApp bundle: workdir/flowsta_private_happ.happ"
echo ""
echo "File sizes:"
